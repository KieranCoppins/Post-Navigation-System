...
namespace KieranCoppins.PostNavigation
{
    ...
    /// </summary>
    public class HasLineOfSight : PostRule
    {
        /// <summary>
        ...
        public HasLineOfSight(Transform target, float heightOffset, float weight) : base(weight, true)
        {
            this.target = target;
        ...
        public override Dictionary<Post, float> Run(Dictionary<Post, float> scores)
        {
            ...
            foreach (KeyValuePair<Post, float> score in scores)
            {
                ...
                Ray ray = new Ray(score.Key + Vector3.up * heightOffset, direction);
